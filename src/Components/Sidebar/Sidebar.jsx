      ...
      <div className="shortcut-links">
        ...
        <div className="Subscribed-list">
          ...
          <div className="side-links">
            <img src={jack} alt=""/><p>marvel</p>
          </div>

          <div className="side-links">
            <img src={simon} alt=""/><p>mr least</p>
          </div>

          <div className="side-links">
            <img src={tom} alt=""/><p>vonkay</p>
          </div>

          <div className="side-links">
            <img src={megan} alt=""/><p>mr bendakay</p>
          </div>

          <div className="side-links">
            <img src={cameron} alt=""/><p>bendu apparao</p>
          </div>
